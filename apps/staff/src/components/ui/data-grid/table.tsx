/* oxlint-disable complexity, func-style, no-nested-ternary, unicorn/no-array-for-each, no-negated-condition, unicorn/no-negated-condition, unicorn/prefer-logical-operator-over-ternary, prefer-for-of, no-plusplus, no-non-null-assertion */
"use client";
